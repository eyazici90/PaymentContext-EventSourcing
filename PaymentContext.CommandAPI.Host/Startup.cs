...
using PaymentContext.Application.Commands.Handlers;
using PaymentContext.Application.DomainEventHandlers;
using PaymentContext.Application.Validations;
...
namespace PaymentContext.CommandAPI.Host
{
                     ...
                     .UseGalaxyRabbitMQ(conf => 
                      {
                          ...
                          conf.QueueName = "PaymentContextPub";
                      })
                     .UseGalaxyMapster()
